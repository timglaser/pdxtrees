...
function neighborhoodListCtrl($scope, $http, mapService) {
  ...
  // embedded here into the controller.
  //
/*
  ...
  var nbrhdSql = '' + 
      'SELECT ' +
        ...
        'MAX(t.diameter) as thickest, ' +
        'AVG(t.diameter) as avgDiameter, ' +
        'MAX(t.spread) as mostSpread, ' +
        'AVG(t.spread) as spread, ' +
  ...
  $http.get(rootQueryUrl + nbrhdSql).success(function(data, status, headers, config) {
    console.log(angular.toJson(data.rows, true));
...
*/
  ...
  //
    ...
    },
    {
      ...
      "thickest": 57,
      "avgdiameter": 48.6666666666667,
      "mostspread": 105,
      "spread": 60.333333333333336,
    ...
    },
    {
      ...
      "thickest": 80,
      "avgdiameter": 40.3571428571429,
      "mostspread": 99,
      "spread": 64.57142857142857,
    ...
    },
    {
      ...
      "thickest": 50,
      "avgdiameter": 40.6666666666667,
      "mostspread": 66,
      "spread": 50.333333333333336,
    ...
    },
    {
      ...
      "thickest": 96,
      "avgdiameter": 59.0909090909091,
      "mostspread": 100,
      "spread": 60.81818181818182,
    ...
    },
    {
      ...
      "thickest": 42,
      "avgdiameter": 24.3333333333333,
      "mostspread": 85,
      "spread": 54.666666666666664,
    ...
    },
    {
      ...
      "thickest": 25,
      "avgdiameter": 22.5714285714286,
      "mostspread": 46,
      "spread": 40.142857142857146,
    ...
    },
    {
      ...
      "thickest": 60,
      "avgdiameter": 36.3333333333333,
      "mostspread": 65,
      "spread": 45.166666666666664,
    ...
    },
    {
      ...
      "thickest": 96,
      "avgdiameter": 55.2727272727273,
      "mostspread": 105,
      "spread": 66.45454545454545,
    ...
    },
    {
      ...
      "thickest": 75,
      "avgdiameter": 35.2222222222222,
      "mostspread": 88,
      "spread": 54.44444444444444,
  ...
  $scope.getSelected = function () {
    return $scope.selectedNeighborhood;
  };
  ...
  $scope.selectNeighborhood = function (neighborhood) {
    ...
    angular.forEach($scope.neighborhoods, function (nbrhd) {
      nbrhd.selected = nbrhd.id === $scope.selectedNeighborhood.id ? true : false;
    });

    // Update map.
    mapService.focusOnNeighborhood($scope.selectedNeighborhood);
